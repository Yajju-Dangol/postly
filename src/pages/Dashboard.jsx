...
import { fetchChannels, fetchPosts, createPost } from '../api/buffer';
...
export const Dashboard = () => {
  ...
  const handlePost = async (data) => {
    ...
    if (result.success) {
      ...
      setToast(`Error: ${msg}`);
      // Don't auto-hide errors as quickly if they are important
  ...
  return (
    <div className="bg-black min-h-screen text-white">
      ...
      <div className="pl-[80px] min-h-screen flex flex-col">
        ...
        <BentoGrid>
          {/* Main Action Area */}
          <BentoItem className="span-2 row-2" title="Create Content" icon={Plus}>
            <PostComposer channels={channels} onPost={handlePost} />
          </BentoItem>
